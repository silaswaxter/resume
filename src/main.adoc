...
2+a|
//* Created a Hardware Abstraction Layer for the peripherals of the STM32L4 
//  microcontroller
* Developed prototype user interface that displays the data stream from each
  sensor and controls the wireless pairing process
* Received Oregon State University scholarship for prototype presentation at
